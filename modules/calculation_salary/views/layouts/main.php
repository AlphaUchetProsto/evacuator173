    ...
    <div class="inner">
            ...
            <nav class="navigation">
                <ul>
                    <li class="row g-0">
                        ...
                        <div class="col">
                            <div class="dropdown">
                                <a href="<?= \yii\helpers\Url::to('/calculation-salary/main/index')?>" class="ajax-link">Расчет зарплаты</a>
                            </div>
                        </div>
                    </li>
                    <li class="row g-0">
                        ...
                        <div class="col">
                            <div class="dropdown">
                                <a href="<?= \yii\helpers\Url::to('/calculation-salary/main/settings')?>" class="ajax-link">Настройки</a>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div class="content">
            <?php if (!empty($this->params['breadcrumbs'])): ?>
                <?= Breadcrumbs::widget([
                    'homeLink' => ['label' => 'Главная', 'url' => '/calculation-salary/main/index', 'class' => 'ajax-link'],
...
<script src="/js/calculation_salary/script.js"></script>
</html>
<?php $this->endPage() ?>
